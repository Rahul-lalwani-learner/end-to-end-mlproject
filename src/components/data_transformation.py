...
@dataclass # dataclass is used to create a class with attributes
...
class DataTransformation:
    ...
    def get_data_transformer_object(self): 
        """
        This function is responsible for returning the preprocessor object and performing the data transformation.
        """
        try: 
            ...
            logging.info("Numerical Column : {}".format(numerical_columns))
            ...
            logging.info("Categorical Column : {}".format(categorical_columns))
